...
// Host follows the non-ESP32 basic-auth path (precomputed basic_auth_hash),
// matching ESPHome 2026.8 (#18237).
struct Credentials {
...
#else
      request->requestAuthentication(nullptr);
#endif
    }
    return success;
  }
